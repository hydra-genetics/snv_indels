...
rule mutect2:
    ...
    log:
        "snv_indels/mutect2/{sample}_{type}_{chr}.output.log",
    benchmark:
        repeat(
            "snv_indels/mutect2/{sample}_{type}_{chr}.output.benchmark.tsv", config.get("mutect2", {}).get("benchmark_repeats", 1)
        )
